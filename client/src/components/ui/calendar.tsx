  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        cell: cn(
          "relative p-0 text-center text-sm focus-within:relative focus-within:z-20 [&:has([aria-selected])]:bg-stone-100 [&:has([aria-selected].day-range-end)]:rounded-r-md [&:has([aria-selected].day-outside)]:bg-stone-100/50 dark:[&:has([aria-selected])]:bg-stone-800 dark:[&:has([aria-selected].day-outside)]:bg-stone-800/50",
          props.mode === "range"
